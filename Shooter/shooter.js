...
function SpawnBullet(){
    setInterval(function(){
        if(input.spacDwn){
            Instantiate(new GameObject("Bullet", "weapon"), [new Renderer(0, "seiji-welsh.github.io/Shooter/images/bullet.png")
...
function LevelCreation(){
    ...
    switch(randNum){
        case 0:
            var asteroid = Instantiate(new GameObject("asteroid", "enemy"), [new Renderer(10, "seiji-welsh.github.io/Shooter/images/asteroid.png")
            ...
            break;
        case 1:
            Instantiate(new GameObject("enemy1", "enemy"), [new Renderer(5, "seiji-welsh.github.io/Shooter/images/enemy1.png")
...
function sceneLoad(){
    ...
    var bg = Instantiate(new GameObject("BG", "background"), [new Renderer(-5, "seiji-welsh.github.io/Shooter/images/bg.png")]
    , canvas.width / 2, canvas.height / 2, canvas.width, canvas.height);
    bg.GetComponent(Renderer).useAntialiasing = true;
    player = Instantiate(new GameObject("Player", "player"), [new Renderer(1, "seiji-welsh.github.io/Shooter/images/ship.png")
