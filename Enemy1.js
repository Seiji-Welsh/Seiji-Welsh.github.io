        ...
        function shootBullet(thisThing){
            if(thisThing.gameObject.alive){
                if(thisThing.playerPoint != 0){
                    var myBullet = Instantiate(new GameObject("Enemy1Bullet", "invinsibleEnemy"), [new Renderer(0, "/Users/lelacreutz/Desktop/JavaScript/Website/Shooter/images/bullet.png")
